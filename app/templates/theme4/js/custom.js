$(function () {
    if(typeof $.AdminBSB.browser != 'undefined')
        $.AdminBSB.browser.activate();
    
    if(typeof $.AdminBSB.leftSideBar != 'undefined')
        $.AdminBSB.leftSideBar.activate();
    
    if(typeof $.AdminBSB.rightSideBar != 'undefined')
        $.AdminBSB.rightSideBar.activate();
    
    if(typeof $.AdminBSB.navbar != 'undefined')
        $.AdminBSB.navbar.activate();

    if(typeof $.AdminBSB.navbar != 'undefined')
        $.AdminBSB.navbar.activate();
    
    if(typeof $.AdminBSB.input != 'undefined')
        $.AdminBSB.input.activate();
    
    if(typeof $.AdminBSB.select != 'undefined')
        $.AdminBSB.select.activate();
    
    if(typeof $.AdminBSB.search != 'undefined')
