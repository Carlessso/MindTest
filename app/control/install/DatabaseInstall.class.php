    ...
    function __construct()
    {
        ...
        try 
        {
            ...
            foreach ($myDatabases as $databaseName => $database) 
            {
                ...
                $this->form->addFields([new TLabel('Base de dados já existe?','#FF0000;')], [$database_exisits]);
                ...
                $this->form->addFields([new TLabel('Usuário já existe?','#FF0000;')], [$user_exisits]);
    ...
    public static function install($params)
    {
        try 
        {
            ...
            foreach ($params['name'] as $key => $name) 
            {
                ...
                $exisits = true;
                if($params['database_exisits'][$key] == 'F' && !empty($ini['name']))
                {
                    $oldName = $ini['name'];
