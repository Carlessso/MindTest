...
class GrupoHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formHeader_Grupo';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('GrupoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('GrupoHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de grupos");
        ...
        $button_cadastrar->setAction(new TAction(['GrupoForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['GrupoHeaderList', 'onExportCsv']), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['GrupoHeaderList', 'onExportPdf']), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['GrupoHeaderList', 'onExportXml']), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Básico","Grupos"]));
        }
