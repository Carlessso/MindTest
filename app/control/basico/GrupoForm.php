...
class GrupoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['GrupoHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('GrupoHeaderList', 'onShow', $loadPageParam); 
