...
class QuestaoHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $column_is_multipla_escolha = new TDataGridColumn('is_multipla_escolha', "Is multipla escolha", 'left');
        ...
        $column_is_obrigatoria = new TDataGridColumn('is_obrigatoria', "Is obrigatoria", 'left');
