...
class GrupoUsuarioHeaderList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'GrupoUsuario';
    private static $primaryKey = 'id';
    private static $formName = 'formHeader_GrupoUsuario';
    ...
    public function __construct($param = null)
    {
        ...
        $grupo_id->setChangeAction(new TAction([$this, 'onSearch'], ['static'=>'1']));
        ...
        $action_onEdit = new TDataGridAction(array('GrupoUsuarioForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('GrupoUsuarioHeaderList', 'onDelete'));
        ...
        $tr->add(TElement::tag('td', $grupo_id));
        ...
        $panel = new TPanelGroup("Listagem de grupo usuarios");
        ...
        $button_cadastrar->setAction(new TAction(['GrupoUsuarioForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['GrupoUsuarioHeaderList', 'onExportCsv']), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['GrupoUsuarioHeaderList', 'onExportPdf']), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['GrupoUsuarioHeaderList', 'onExportXml']), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Básico","Grupo usuarios"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new GrupoUsuario($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for GrupoUsuario
