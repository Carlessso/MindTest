...
class GrupoProvaHeaderList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'GrupoProva';
    private static $primaryKey = 'id';
    private static $formName = 'formHeader_GrupoProva';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('GrupoProvaForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('GrupoProvaHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de grupo provas");
        ...
        $button_cadastrar->setAction(new TAction(['GrupoProvaForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['GrupoProvaHeaderList', 'onExportCsv']), 'datagrid_'.self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['GrupoProvaHeaderList', 'onExportPdf']), 'datagrid_'.self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['GrupoProvaHeaderList', 'onExportXml']), 'datagrid_'.self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Básico","Grupo provas"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new GrupoProva($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for GrupoProva
