...
class SystemAccessLogList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['SystemAccessLogList', 'onExportCsv']), 'form_search_SystemSqlLog', 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['SystemAccessLogList', 'onExportPdf']), 'form_search_SystemSqlLog', 'far:file-pdf #e74c3c' );
