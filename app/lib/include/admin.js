...
Template.onAfterLoad = function(url, data) {
    ...
    if ((url.indexOf("target_container=adianti_right_panel") !== -1) || (data.indexOf('adianti_target_container="adianti_right_panel"') !== -1) ) {
        ...
        var url_param = __adianti_query_to_json(url);
        
        if ($('#adianti_right_panel').is(":visible") && typeof url_param['target_container'] != 'undefined' && $('#adianti_right_panel').find('#'+url_param['target_container']).length == 0) {
